...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pfContra.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N

        btnEntrar.setFont(new java.awt.Font("Comic Sans MS", 0, 14)); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(21, 21, 21)
                                        .addComponent(lblCorreo, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGap(18, 18, 18)
                                        .addComponent(pfContra, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        ...
        try {
            Statement datosclientes = cn.createStatement();
            ResultSet result = datosclientes.executeQuery("SELECT * FROM clientes");
            while (result.next()) {
                String usuario = result.getString("Correo");
